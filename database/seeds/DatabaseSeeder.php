...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        /*=============================================
        CREANDO 50 CARROS ASIGNADOS A UN CLIENTE Y UN PLAN
        =============================================*/
            factory(\App\Car::class, 50)->create()
            ->each(function (\App\Car $car){
                factory(\App\CarSubscription::class, 1)->create()->each(function () use ($car){
                   /* $s->car()->attach($car->id);*/
                    $data = array(
                        array('cars_id'=>\App\Car::all()->random()->id,  'plan_id' => \App\Plan::all()->random()->id)
                    );
