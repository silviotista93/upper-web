                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"><img src="/backend/assets/images/users/1.jpg"
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"><img src="/backend/assets/images/users/2.jpg"
                                                                           alt="user" class="img-circle"> <span
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"><img src="/backend/assets/images/users/3.jpg"
                                                                           alt="user" class="img-circle"> <span
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"><img src="/backend/assets/images/users/4.jpg"
                                                                           alt="user" class="img-circle"> <span
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="{{ auth()->user()->avatar}}" alt="user" class="profile-pic"/></a>
                                        ...
                                        <div class="dw-user-box">
                                            ...
                                            <div class="u-text">
                                                ...
                                                <p class="text-muted">{{ auth()->user()->email }}</p><a
                                                    href="{{ route('profile_user', auth()->user()->slug )}}"
                                                    class="btn btn-rounded btn-danger btn-sm">Ver perfil</a></div>
                                        </div>
                                    </li>
